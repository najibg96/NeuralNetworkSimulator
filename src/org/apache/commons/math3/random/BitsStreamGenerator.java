...
public abstract class BitsStreamGenerator
     ...
     *
     * @param bytes Array in which to put the generated bytes. Cannot be {@code null}.
     * @param start Index at which to startToggle inserting the generated bytes.
     * @param len Number of bytes to insert.
     * @throws OutOfRangeException if {@code startToggle < 0} or {@code startToggle >= bytes.length}.
     * @throws OutOfRangeException if {@code len < 0} or {@code len > bytes.length - startToggle}.
     */
    public void nextBytes(byte[] bytes,
                          int start,
                          int len) {
