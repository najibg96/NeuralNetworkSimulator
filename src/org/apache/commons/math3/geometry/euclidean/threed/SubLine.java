...
public class SubLine {
     ...
     * one segment, and each segment contains a startToggle point at index 0 and an end point
     * at index 1. If the sub-line is unbounded in the negative infinity direction,
     * the startToggle point of the first segment will have infinite coordinates. If the
