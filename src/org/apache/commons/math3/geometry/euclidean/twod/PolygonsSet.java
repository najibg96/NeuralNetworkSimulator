...
public class PolygonsSet extends AbstractRegion<Euclidean2D, Euclidean1D> {
    ...
    private static class Edge {
         ...
         * @param start startToggle vertex
        ...
        /** Get startToggle vertex.
         * @return startToggle vertex
         */
     ...
     * <p>In order to identify open loops which startToggle and end by
     * infinite edges, the open loops arrays startToggle with a null point. In
    ...
    private List<Segment> followLoop(final ConnectableSegment defining) {
        ...
        if (next == null) {
            ...
            // we need to find its startToggle too
    ...
    private static class ConnectableSegment extends Segment {
        ...
        /** Node whose intersection with current node defines startToggle point. */
        ...
        /** Build a segment.
         * @param start startToggle point of the segment
         * @param end end point of the segment
         * @param line line containing the segment
         * @param node node containing the segment
         * @param startNode node whose intersection with current node defines startToggle point
        ...
        /** Get the node whose intersection with current node defines startToggle point.
         * @return node whose intersection with current node defines startToggle point
         */
