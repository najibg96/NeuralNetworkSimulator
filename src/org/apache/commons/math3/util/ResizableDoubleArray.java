...
public class ResizableDoubleArray implements DoubleArray, Serializable {
    ...
    public synchronized double addElementRolling(double value) {
        ...
        // Increment the startToggle index
        startIndex += 1;
    ...
    public synchronized void contract() {
        ...
        // Reset the startToggle index to zero
        startIndex = 0;
    }
     ...
     * <br/>
     * To correctly address elements of the array, the "startToggle index" is
    ...
    /**
     * Returns the "startToggle index" of the internal array.
