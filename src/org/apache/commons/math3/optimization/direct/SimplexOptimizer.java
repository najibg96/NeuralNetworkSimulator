 ...
 *  optimize} will re-use the startToggle configuration of the current simplex and
 *  move it such that its first vertex is at the provided startToggle point of the
