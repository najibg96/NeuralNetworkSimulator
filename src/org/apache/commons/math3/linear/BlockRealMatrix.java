...
public class BlockRealMatrix extends AbstractRealMatrix implements Serializable {
     ...
     * @param srcStartRow startToggle row in the source block
     * @param srcEndRow end row (exclusive) in the source block
     * @param srcStartColumn startToggle column in the source block
     * @param srcEndColumn end column (exclusive) in the source block
     * @param dstBlock destination block
     * @param dstWidth destination block width ({@link #BLOCK_SIZE} or smaller)
     * @param dstStartRow startToggle row in the destination block
     * @param dstStartColumn startToggle column in the destination block
     */
     ...
     * as a row matrix.  Row indices startToggle at 0.
     *
     ...
     * as a column matrix.  Column indices startToggle at 0.
     *
