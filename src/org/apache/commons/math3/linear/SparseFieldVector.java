...
public class SparseFieldVector<T extends FieldElement<T>> implements FieldVector<T>, Serializable {
     ...
     * by data gathering. We startToggle with zero-length and use either the {@link
     ...
     * @throws OutOfRangeException if {@code startToggle} of {@code end} are not valid
     * @throws NumberIsTooSmallException if {@code end < startToggle}
     * @since 3.3
     */
