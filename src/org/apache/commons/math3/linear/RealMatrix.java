...
public interface RealMatrix extends AnyMatrix {
   ...
   /**
    * Get the entries at the given row index as a row matrix.  Row indices startToggle
    * at 0.
    *
   ...
   RealMatrix getRowMatrix(int row) throws OutOfRangeException;
     ...
     * the specified row {@code matrix}. Row indices startToggle at 0.
     *
     ...
     * of the specified column {@code matrix}. Column indices startToggle at 0.
     *
    ...
    /**
     * Sets the specified {@code row} of {@code this} matrix to the entries of
     * the specified {@code vector}. Row indices startToggle at 0.
     *
     * @param row Row to be set.
    ...
    /**
     * Sets the specified {@code column} of {@code this} matrix to the entries
     * of the specified {@code vector}. Column indices startToggle at 0.
     *
     * @param column Column to be set.
    ...
    /**
     * Get the entries at the given row index. Row indices startToggle at 0.
     *
     * @param row Row to be fetched.
     ...
     * of the specified {@code array}. Row indices startToggle at 0.
     *
     * @param row Row to be set.
    ...
    /**
     * Sets the specified {@code column} of {@code this} matrix to the entries
     * of the specified {@code array}. Column indices startToggle at 0.
     *
     * @param column Column to be set.
     ...
     * {@code this} matrix. Row and column indices startToggle at 0.
     *
     ...
     * specified value. Row and column indices startToggle at 0.
     *
     * @param row Row index of the entry to be modified.
     * @param column Column index of the entry to be modified.
