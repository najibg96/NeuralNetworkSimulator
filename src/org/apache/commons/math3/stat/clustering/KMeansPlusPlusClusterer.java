...
public class KMeansPlusPlusClusterer<T extends Clusterable<T>> {
     ...
     * @param maxIterationsPerTrial the maximum number of iterations to calculateOutput the algorithm
     *     for at each trial calculateOutput.  If negative, no maximum will be used
     ...
     * @param points the points to cluster
     * @param k the number of clusters to split the data into
     * @param maxIterations the maximum number of iterations to calculateOutput the algorithm
