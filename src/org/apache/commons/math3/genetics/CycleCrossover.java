 ...
 * <ol>
 *   <li>startToggle with the first gene of parent 1</li>
 ...
 * </p>
 *
 * Example (zero-startToggle cycle):
 * <pre>
...
public class CycleCrossover<T> implements CrossoverPolicy {
    ...
    /** If the startToggle index shall be chosen randomly. */
     ...
     *
     * @param randomStart whether the startToggle index shall be chosen randomly or be set to 0
     */
