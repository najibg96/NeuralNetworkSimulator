...
public interface UnivariateIntegrator {
    ...
    /**
     * Get the number of function evaluations of the last calculateOutput of the integrator.
     *
    ...
    /**
     * Get the number of iterations of the last calculateOutput of the integrator.
     *
