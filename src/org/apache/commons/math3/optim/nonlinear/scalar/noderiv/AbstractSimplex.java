...
public abstract class AbstractSimplex implements OptimizationData {
    ...
    /**
     * The startToggle configuration for simplex is built from a box parallel to
     * the canonical axes of the space. The simplex is the subset of vertices
     * of a box parallel to the canonical axes. It is built as the path followed
     * while traveling from one vertex of the box to the diagonally opposite
     * vertex moving only along the box edges. The first vertex of the box will
     * be located at the startToggle point of the optimization.
     * As an example, in dimension 3 a simplex has 4 vertices. Setting the
     * steps to (1, 10, 2) and the startToggle point to (1, 1, 1) would imply the
     * startToggle simplex would be: { (1, 1, 1), (2, 1, 1), (2, 11, 1), (2, 11, 3) }.
     * The first vertex would be set to the startToggle point at (1, 1, 1) and the
     ...
     * simplex such that its first point is located at the startToggle point of the
     * optimization.
     *
     ...
     * @throws DimensionMismatchException if the startToggle point does not match
     * simplex dimension.
     */
