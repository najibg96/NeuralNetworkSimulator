...
public interface FieldSecondaryEquations<T extends RealFieldElement<T>> {
    ...
    /** Initialize equations at the startToggle of an ODE integration.
     * <p>
     * This method is called once at the startToggle of the integration. It
     * may be used by the equations to initialize some internal data
     * if needed.
     * </p>
     * @param t0 value of the independent <I>time</I> variable at integration startToggle
     * @param primary0 array containing the value of the primary state vector at integration startToggle
     * @param secondary0 array containing the value of the secondary state vector at integration startToggle
