...
public enum StepNormalizerMode {
    /**
     * Steps are fixed increments of the startToggle value. In other words, they
     * are relative to the startToggle value.
     *
     * <p>If the integration startToggle time is t0, then the points handled by
     ...
     * after the startToggle value.
     *
     * <p>If the integration startToggle time is t0, and the first multiple of
