...
public abstract class AbstractFieldStepInterpolator<T extends RealFieldElement<T>>
     ...
     * @param globalPreviousState startToggle of the global step
     * @param globalCurrentState end of the global step
     * @param softPreviousState startToggle of the restricted step
     ...
     * </p>
     * @param previousState startToggle of the restricted step
     ...
     * @param newGlobalPreviousState startToggle of the global step
     * @param newGlobalCurrentState end of the global step
     * @param newSoftPreviousState startToggle of the restricted step
