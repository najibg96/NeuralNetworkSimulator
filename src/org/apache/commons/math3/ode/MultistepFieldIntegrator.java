...
public abstract class MultistepFieldIntegrator<T extends RealFieldElement<T>>
     ...
     * and initializes the Nordsieck vector at step startToggle. The starter integrator
    ...
    protected void start(final FieldExpandableODE<T> equations, final FieldODEState<T> initialState, final T t)
        ...
        // startToggle integration, expecting a InitializationCompletedMarkerException
        try {
            ...
            // this is the expected nominal interruption of the startToggle integrator
    ...
    /** Initialize the high order scaled derivatives at step startToggle.
    ...
    private class FieldNordsieckInitializer implements FieldStepHandler<T> {
         ...
         * @param nbStartPoints number of startToggle points (including the initial point)
         */
