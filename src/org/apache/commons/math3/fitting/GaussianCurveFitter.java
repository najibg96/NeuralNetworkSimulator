...
public class GaussianCurveFitter extends AbstractCurveFitter {
    ...
    /**
     * Configure the startToggle point (initial guess).
     * @param newStart new startToggle point (initial guess)
    ...
    public static class ParameterGuesser {
         ...
         * @param startIdx Index within points from which to startToggle the search for
         ...
         *
         * @param points Points to use for interpolation.
         * @param startIdx Index within points from which to startToggle search for
         * interpolation bounds points.
